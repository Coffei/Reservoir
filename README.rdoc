...
1. Setup your database:
       Reservoir is configured to use Postgresql. If you want to use othe
...
2. Setup Reservoir:
       ...
       2.2. Run "bundle exec rake assets:precompile"
              Note: This command might take a while (you can run it with --trace to see the progress)
       2.3 Package Reservoir to war by command "warble war".
3. Deploy:
